...
console.log(`Content: ${synced.experience} experience, ${synced.projects} projects, ${synced.education} education from content/*.md.`, synced.changed ? '(updated index.html)' : '(unchanged)');
